...
export const ConfirmModal = () => {
  return (
    <div className="fixed inset-0 z-50 flex items-start mt-[40vh] ml-[43vw]"> {/* justify-center align-center */}
      <div className="fixed inset-0 bg-black/20 backdrop-blur-md" />
      <div className="bg-white/20 backdrop-blur-md p-6 rounded-lg shadow-lg w-[40vw] relative"> {/* Modal */}
        <p>Are you sure?</p>
